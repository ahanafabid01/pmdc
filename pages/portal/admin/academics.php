...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>/pages/portal/admin/css/academics.css?v=<?= time() ?>">
</head>
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?= BASE_URL ?>/admin/academics" class="nav-item active"><i class="fas fa-book-open"></i><span>Academics</span></a>
                    ...
                    <table class="tm-table" id="hscTable">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width:140px;" class="text-center">Compulsory</th>
                                <th style="min-width:140px;" class="text-center">Optional</th>
                                <th style="min-width:140px;" class="text-center">4th Subject</th>
    ...
    <script src="<?= BASE_URL ?>/pages/portal/admin/js/academics.js?v=<?= time() ?>"></script>
    <script>
    (function () {
