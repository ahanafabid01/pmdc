...
<head>
    ...
    <title>Degree Registration Management | PMDC Admin</title>
    ...
    <div class="content-area">
        ...
        <div class="tm-page-header">
            <div class="tm-page-title">
                <h1>Degree Registration</h1>
                <p>Manage Degree admission registrations — settings, review, and approval</p>
            </div>
            <div class="tm-header-actions">
                <a href="../../../pages/register-degree.php" target="_blank" class="btn-preview">
            ...
            <div class="ra-status-row">
                <div class="ra-status-info">
                    ...
                    <div>
                        ...
                        <div class="ra-status-sub">Toggle to open or close the public Degree registration form</div>
                    </div>
                </div>
        ...
        <div class="ra-section-head">
            <div class="ra-section-left">
                ...
                <div>
                    ...
                    <div class="ra-section-sub">All Degree registration applications for the current session</div>
                </div>
            </div>
    ...
    <div class="tm-modal ra-detail-modal" role="dialog" aria-modal="true">
        ...
        <div class="tm-modal-body">
            ...
            <div class="ra-detail-section">
                <div class="ra-detail-section-title"><i class="fas fa-graduation-cap"></i> Academic Information (HSC)</div>
                <div class="ra-detail-grid">
                    <div class="ra-detail-item"><span class="ra-detail-lbl">Roll / Reg. No.</span><span class="ra-detail-val" id="dAcad1">—</span></div>
                    <div class="ra-detail-item"><span class="ra-detail-lbl">Board / Year</span><span class="ra-detail-val" id="dAcad2">—</span></div>
                    <div class="ra-detail-item"><span class="ra-detail-lbl">GPA</span><span class="ra-detail-val" id="dAcad3">—</span></div>
                    <div class="ra-detail-item"><span class="ra-detail-lbl">Group → Desired</span><span class="ra-detail-val" id="dAcad4">—</span></div>
                    <div class="ra-detail-item full"><span class="ra-detail-lbl">Previous Institution</span><span class="ra-detail-val" id="dAcad5">—</span></div>
                </div>
            </div>
            ...
            <div class="ra-detail-section">
                ...
                <div class="ra-doc-grid">
                    ...
                    <div class="ra-doc-card"><div id="docCert"><div class="ra-doc-none"><i class="fas fa-file-alt"></i></div></div><div class="ra-doc-label">HSC Certificate</div></div>
