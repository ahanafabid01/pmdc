...
$page       = 'register-hsc';
$page_group = 'academic';
$page_title = 'HSC Registration Form | Phulpur Mohila Degree College';
$base_path  = '../';
...
<section class="page-hero">
    <div class="container ph-content">
        <nav class="ph-breadcrumb reveal">
            ...
            <a href="hsc-form-fillup.php">HSC Form Fillup</a> <i class="fas fa-chevron-right"></i>
            <span>Apply Now</span>
        </nav>
        <div class="ph-kicker reveal">ADMISSION <?php echo htmlspecialchars($session); ?></div>
        <h1 class="reveal" data-i18n="title">HSC Registration Form</h1>
        <p class="reveal" data-i18n="subtitle">Fill in all required fields carefully. All fields marked * are mandatory.</p>
        <?php if ($state === 'open'): ?>
        <div class="ph-badge-row reveal">
            ...
            <span class="ph-badge"><i class="fas fa-money-bill-wave"></i> Registration Fee: ৳<?php echo $fee; ?></span>
...
<div class="reg-page">
    ...
    <div class="reg-closed-wrap">
        ...
        <p class="reg-closed-msg">
            HSC registration for session <strong><?php echo htmlspecialchars($session); ?></strong> has not started yet.
            <?php if ($open_date_fmt): ?>
            Registration will open on <strong><?php echo $open_date_fmt; ?></strong>.
            <?php endif; ?>
        </p>
    ...
    <div class="reg-closed-wrap">
        ...
        <p class="reg-closed-msg">
            Registration for session <strong><?php echo htmlspecialchars($session); ?></strong> is currently closed.
            <?php if ($close_date_fmt): ?>
            The registration window closed on <strong><?php echo $close_date_fmt; ?></strong>.
            <?php endif; ?>
        </p>
    ...
    <div class="reg-card">
        ...
        <div class="reg-step" id="step2">
            ...
            <hr class="reg-section-sep"><div class="reg-section-head"><i class="fas fa-star"></i> Desired HSC Information</div>
            <div class="reg-grid">
                <div class="reg-group"><label for="desired_group">Desired Group for HSC <span class="req">*</span></label><select id="desired_group"><option value="">— Select —</option><option>Science</option><option>Humanities</option><option>Business Studies</option></select><span class="reg-err" id="err_desired_group"></span></div>
                <div class="reg-group"><label for="desired_section">Preferred Section</label><select id="desired_section"><option value="">— No Preference —</option><option>A</option><option>B</option><option>C</option></select></div>
        ...
        <div class="reg-step" id="step3">
            ...
            <div class="reg-uploads">
                ...
                <div class="reg-upload-zone" id="zone_cert"><input type="file" id="upload_cert" accept=".jpg,.jpeg,.png,.pdf"><div class="reg-doc-placeholder"><i class="fas fa-file-alt"></i></div><img class="reg-doc-thumb" id="cert_preview" src="" alt="Certificate"><div class="reg-upload-info"><div class="reg-upload-title">SSC Certificate / Marksheet <span class="req" style="color:#dc2626;">*</span></div><div class="reg-upload-hint">Clear photo or scan · JPG/PNG/PDF · Max 5MB</div><div class="reg-upload-cta"><i class="fas fa-cloud-upload-alt"></i> Click to upload or drag &amp; drop</div><div class="reg-upload-filename" id="cert_filename"></div></div><button type="button" class="reg-upload-remove" title="Remove"><i class="fas fa-times"></i></button></div>
        ...
        <div class="reg-step" id="step4">
            ...
            <div class="reg-pay-info">
                <div class="reg-pay-info-title">Registration Fee</div>
