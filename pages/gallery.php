    ...
    <div class="container">
        ...
        <div class="gallery-year-section" data-year-section="<?php echo $year; ?>">
            ...
            <div class="gys-header reveal">
                <div class="gys-title">
                    <div class="gys-year-pill">
                        <i class="fas fa-calendar-alt"></i>
                        <span class="gys-year-num"><?php echo $year; ?></span>
                    </div>
                    <span class="gys-subtitle" data-i18n="gallery.year.subtitle">সালের স্মৃতিচারণ</span>
                </div>
                <div class="gys-meta">
            ...
            <div class="gallery-grid" id="grid-<?php echo $year; ?>" data-year="<?php echo $year; ?>">
                <?php foreach ($photos as $idx => $photo):
                    ...
                    /* First tile of each year is featured (spans 2x2) */
                    $featured = ($idx === 0) ? 'gallery-thumb--featured' : '';
                ?>
                <div class="gallery-thumb <?php echo $featured; ?>"
                     <?php echo $extra; ?>
                    ...
                    <div class="gthumb-overlay">
                        <div class="gthumb-actions">
                            <div class="gthumb-zoom"><i class="fas fa-expand-alt"></i></div>
                        </div>
                    </div>
                    <div class="gthumb-info">
                        <span class="gthumb-label"><?php echo $title; ?></span>
                        <span class="gthumb-date"><?php echo $date; ?></span>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
