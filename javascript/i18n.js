...
(function () {
    ...
    const T = {
        ...
        'nav.results_academic': { en: 'Academic Results', bn: 'একাডেমিক ফলাফল' },
        'nav.results_hsc': { en: 'HSC Exam Result', bn: 'এইচএসসি বোর্ড ফলাফল' },
        'nav.results_nu': { en: 'National University Result', bn: 'জাতীয় বিশ্ববিদ্যালয় ফলাফল' },
        'nav.contact': { en: 'Contact', bn: 'যোগাযোগ' },
        'nav.apply': { en: 'Apply Now', bn: 'ভর্তি' },
        'nav.apply_hsc': { en: 'HSC Admission', bn: 'এইচএসসি ভর্তি' },
        ...
        /* ━━━━━━━━━━━ ABOUT PAGE ━━━━━━━━━━━ */
        'about.hero.kicker': { en: 'About PMDC', bn: 'পিএমডিসি সম্পর্কে' },
        'about.hero.h1': { en: 'Empowering Women Through<br>Education Since 1994', bn: '১৯৯৪ সাল থেকে শিক্ষার মাধ্যমে<br>নারীর ক্ষমতায়ন' },
        'about.hero.desc': { en: 'Phulpur Mohila Degree College — a trusted institution for women\'s education in Phulpur, Mymensingh.', bn: 'ফুলপুর মহিলা ডিগ্রি কলেজ — ফুলপুর, ময়মনসিংহের নারী শিক্ষার একটি নির্ভরযোগ্য প্রতিষ্ঠান.' },
        
        'about.principal.kicker': { en: 'Principal\'s Message', bn: 'অধ্যক্ষের বার্তা' },
        'about.principal.h2': { en: 'Building the Foundation<br>of Students\' Futures', bn: 'শিক্ষার্থীদের ভবিষ্যতের<br>ভিত্তি নির্মাণ' },
        'about.principal.p1': { en: 'Phulpur Mohila Degree College was established in 1994 with the collective effort of people across all political lines, with the goal of enabling women in Phulpur to pursue higher education equally alongside men.', bn: 'ফুলপুর মহিলা ডিগ্রি কলেজ ১৯৯৪ সালে সকল রাজনৈতিক দলের মানুষের সম্মিলিত প্রচেষ্টায় প্রতিষ্ঠিত হয়, যার লক্ষ্য ছিল ফুলপুরের নারীদের পুরুষের সমকক্ষে উচ্চশিক্ষার সুযোগ দেওয়া।' },
        'about.principal.p2': { en: 'Degree programmes (BA, BSS, BSc) began from the 2003–2004 academic session, and HSC, including Business Management & Technology (BMT), began from the 2004–2005 session. The college has experienced and trained faculty, disciplined administration, strong security, a large computer lab, library, and CCTV surveillance.', bn: 'ডিগ্রি প্রোগ্রাম (বিএ, বিএসএস, বিএসসি) ২০০৩-২০০৪ শিক্ষাবর্ষ থেকে শুরু হয় এবং এইচএসসি, ব্যবসায় ব্যবস্থাপনা ও প্রযুক্তি (বিএমটি) সহ ২০০৪-২০০৫ শিক্ষাবর্ষ থেকে চালু হয়। কলেজে অভিজ্ঞ শিক্ষকমণ্ডলী, সুশৃঙ্খল প্রশাসন, শক্তিশালী নিরাপত্তা, বড় কম্পিউটার ল্যাব, পাঠাগার এবং সিসিটিভি নজরদারি রয়েছে।' },
        'about.principal.p3': { en: 'I warmly welcome every student, guardian, and visitor to our college. Together, we will continue working to build a brighter tomorrow for the women of Phulpur.', bn: 'আমি আমাদের কলেজে প্রতিটি শিক্ষার্থী, অভিভাবক এবং দর্শনার্থীকে আন্তরিকভাবে স্বাগত জানাই। একসাথে, আমরা ফুলপুরের নারীদের জন্য একটি উজ্জ্বল আগামী গড়তে কাজ চালিয়ে যাব।' },
        'about.principal.name': { en: 'Rowshan Ara Begum', bn: 'রওশন আরা বেগম' },
        'about.principal.title': { en: 'Principal, Phulpur Mohila Degree College', bn: 'অধ্যক্ষ, ফুলপুর মহিলা ডিগ্রি কলেজ' },
        
        'about.mvv.kicker': { en: 'Our Foundation', bn: 'আমাদের ভিত্তি' },
        'about.mvv.h2': { en: 'Mission, Vision & Values', bn: 'লক্ষ্য, উদ্দেশ্য ও মূল্যবোধ' },
        'about.mvv.sub': { en: 'The principles that define our identity and guide all our actions.', bn: 'যে নীতিগুলি আমাদের পরিচয় নির্ধারণ করে এবং আমাদের সমস্ত কাজকে পরিচালিত করে।' },
        'about.mvv.mission.label': { en: 'Mission', bn: 'লক্ষ্য' },
        'about.mvv.mission.h3': { en: 'Our Mission', bn: 'আমাদের লক্ষ্য' },
        'about.mvv.mission.p': { en: 'To provide quality and inclusive education to women in the Phulpur region — equipping them with the knowledge, values, and skills needed to excel academically and professionally.', bn: 'ফুলপুর অঞ্চলের নারীদের মানসম্পন্ন ও অন্তর্ভুক্তিমূলক শিক্ষা প্রদান করা — তাদের জ্ঞান, মূল্যবোধ ও দক্ষতা দিয়ে সজ্জিত করা যাতে তারা একাডেমিক এবং পেশাগত জীবনে উৎকর্ষতা অর্জন করতে পারে।' },
        'about.mvv.vision.label': { en: 'Vision', bn: 'উদ্দেশ্য' },
        'about.mvv.vision.h3': { en: 'Our Vision', bn: 'আমাদের উদ্দেশ্য' },
        'about.mvv.vision.p': { en: 'To become the leading women\'s degree college in Mymensingh division — recognized for academic excellence, moral values, and holistic empowerment of every student who enters our institution.', bn: 'ময়মনসিংহ বিভাগের শীর্ষস্থানীয় মহিলা ডিগ্রি কলেজে পরিণত হওয়া — একাডেমিক উৎকর্ষতা, নৈতিক মূল্যবোধ এবং আমাদের প্রতিষ্ঠানে আসা প্রতিটি শিক্ষার্থীর সার্বিক ক্ষমতায়নের জন্য স্বীকৃত হওয়া।' },
        'about.mvv.values.label': { en: 'Values', bn: 'মূল্যবোধ' },
        'about.mvv.values.h3': { en: 'Our Values', bn: 'আমাদের মূল্যবোধ' },
        'about.mvv.values.p': { en: 'Integrity, Excellence, Respect, and Community. We uphold the highest ethical standards, foster discipline and compassion, and celebrate the unique potential of every student.', bn: 'সততা, উৎকর্ষতা, সম্মান এবং সম্প্রদায়। আমরা সর্বোচ্চ নৈতিক মান বজায় রাখি, শৃঙ্খলা ও সহানুভূতি লালন করি এবং প্রতিটি শিক্ষার্থীর অনন্য সম্ভাবনা উদযাপন করি।' },
        
        'about.timeline.kicker': { en: 'Our Journey', bn: 'আমাদের যাত্রা' },
        'about.timeline.h2': { en: 'History & Milestones', bn: 'ইতিহাস ও মাইলফলক' },
        'about.timeline.sub': { en: 'Four decades of contribution to women\'s education in Phulpur.', bn: 'ফুলপুরে নারী শিক্ষায় অবদানের চার দশক।' },
        'about.timeline.1994.h4': { en: 'Establishment', bn: 'প্রতিষ্ঠা' },
        'about.timeline.1994.p': { en: 'Phulpur Mohila Degree College was established with the goal of providing quality higher secondary education to women in the Phulpur area of Mymensingh district.', bn: 'ফুলপুর মহিলা ডিগ্রি কলেজ ময়মনসিংহ জেলার ফুলপুর এলাকার নারীদের মানসম্পন্ন উচ্চ মাধ্যমিক শিক্ষা প্রদানের লক্ষ্যে প্রতিষ্ঠিত হয়।' },
        'about.timeline.2003.h4': { en: 'Degree Programmes Initiated', bn: 'ডিগ্রি প্রোগ্রাম শুরু' },
        'about.timeline.2003.p': { en: 'BA, BSS, and BSc degree programmes were introduced from the 2003-2004 academic session.', bn: 'বিএ, বিএসএস এবং বিএসসি ডিগ্রি প্রোগ্রামগুলি ২০০৩-২০০৪ শিক্ষাবর্ষ থেকে শুরু হয়।' },
        'about.timeline.2004.h4': { en: 'HSC & BMT Introduced', bn: 'এইচএসসি ও বিএমটি চালু' },
        'about.timeline.2004.p': { en: 'HSC, including Business Management & Technology (BMT), started from the 2004-2005 session.', bn: 'এইচএসসি, ব্যবসায় ব্যবস্থাপনা ও প্রযুক্তি (বিএমটি) সহ ২০০৪-২০০৫ শিক্ষাবর্ষ থেকে শুরু হয়।' },
        'about.timeline.2026.h4': { en: 'Modern Facilities', bn: 'আধুনিক সুবিধাসমূহ' },
        'about.timeline.2026.p': { en: 'The college continues to maintain experienced faculty, strong security, a large computer lab, library, and CCTV surveillance for female students.', bn: 'কলেজটি মহিলা শিক্ষার্থীদের জন্য অভিজ্ঞ শিক্ষকমণ্ডলী, শক্তিশালী নিরাপত্তা, একটি বড় কম্পিউটার ল্যাব, পাঠাগার এবং সিসিটিভি নজরদারি বজায় রেখে চলেছে।' },
        
        'about.team.kicker': { en: 'Our Team', bn: 'আমাদের দল' },
        'about.team.h2': { en: 'College Leadership', bn: 'কলেজ নেতৃত্ব' },
        'about.team.sub': { en: 'Dedicated administrators and faculty heads guiding PMDC towards a brighter future.', bn: 'নিবেদিতপ্রাণ প্রশাসক এবং অনুষদ প্রধানরা পিএমডিসিকে একটি উজ্জ্বল ভবিষ্যতের দিকে পরিচালিত করছেন।' },
        'about.team.p.name': { en: 'Rowshan Ara Begum', bn: 'রওশন আরা বেগম' },
        'about.team.p.role': { en: 'Head of Institution', bn: 'প্রতিষ্ঠান প্রধান' },
        'about.team.p.dept': { en: 'Administration', bn: 'প্রশাসন' },
        'about.team.s.name': { en: 'Head of Science Department', bn: 'বিজ্ঞান বিভাগীয় প্রধান' },
        'about.team.s.role': { en: 'Department Head', bn: 'বিভাগীয় প্রধান' },
        'about.team.s.dept': { en: 'Science Department', bn: 'বিজ্ঞান বিভাগ' },
        'about.team.c.name': { en: 'Head of Commerce Department', bn: 'বাণিজ্য বিভাগীয় প্রধান' },
        'about.team.c.role': { en: 'Department Head', bn: 'বিভাগীয় প্রধান' },
        'about.team.c.dept': { en: 'Business Studies Department', bn: 'ব্যবসায় শিক্ষা বিভাগ' },
        'about.team.h.name': { en: 'Head of Humanities Department', bn: 'মানবিক বিভাগীয় প্রধান' },
        'about.team.h.role': { en: 'Department Head', bn: 'বিভাগীয় প্রধান' },
        'about.team.h.dept': { en: 'Humanities Department', bn: 'মানবিক বিভাগ' },
        
        'about.cta.h2': { en: 'Ready to Join Our College?', bn: 'আমাদের কলেজে যোগ দিতে প্রস্তুত?' },
        'about.cta.p': { en: 'HSC and degree admissions are open for eligible students.', bn: 'এইচএসসি এবং ডিগ্রি ভর্তির জন্য যোগ্য শিক্ষার্থীদের আবেদন চলছে।' },
        ...
        'ts.hero.kicker':   { en: 'Our Team', bn: 'আমাদের দল' },
        'ts.hero.h1':       { en: 'Teachers & Staff', bn: 'শিক্ষক ও কর্মচারী' },
        'ts.hero.desc':     { en: 'Meet the dedicated team behind Phulpur Mohila Degree College', bn: 'ফুলপুর মহিলা ডিগ্রি কলেজের নিবেদিতপ্রাণ দলের সাথে পরিচিত হন' },
        'ts.hero.teachers': { en: 'Teaching Staff', bn: 'শিক্ষকবৃন্দ' },
        'ts.hero.admin':    { en: 'Admin Staff', bn: 'প্রশাসনিক কর্মী' },
        'ts.hero.support':  { en: 'Support Staff', bn: 'সহায়ক কর্মী' },
        'ts.search':        { en: 'Search by name or designation...', bn: 'নাম বা পদবি দিয়ে খুঁজুন...' },
        'ts.section.teaching': { en: 'Teaching Staff', bn: 'শিক্ষকমণ্ডলী' },
        'ts.section.admin':    { en: 'Administrative Staff', bn: 'প্রশাসনিক কর্মী' },
        'ts.section.support':  { en: 'Support Staff', bn: 'সহায়ক কর্মী' },
        'ts.empty.teacher': { en: 'No teachers have been added yet.', bn: 'এখনও কোনো শিক্ষক যোগ করা হয়নি।' },
        'ts.empty.admin':   { en: 'No administrative staff added yet.', bn: 'এখনও কোনো প্রশাসনিক কর্মী যোগ করা হয়নি।' },
        'ts.empty.support': { en: 'No support staff added yet.', bn: 'এখনও কোনো সহায়ক কর্মী যোগ করা হয়নি।' },
